...
def init_args():
    ...
    parser.add_argument('--dataset_dir', default="D:\\yinyuanqi\\labelme\\", type=str, help='The source nsfw data dir path')
    parser.add_argument('--tfrecords_dir',default="D:\\yinyuanqi\\labelme\\tfrecords", type=str, help='The dir path to save converted tfrecords')
...
if __name__ == '__main__':
    ...
    # 生成 tfrecords 的 step
    producer.generate_tfrecords(save_dir=args.tfrecords_dir, step_size=1)
