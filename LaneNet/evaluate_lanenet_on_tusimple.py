...
def init_args():
    ...
    parser.add_argument('--image_dir', type=str, default='D:\\yinyuanqi\\lanenet-lane-detection-master\\dataset\\clips\\test_1', help='The source tusimple lane test data dir')
    # parser.add_argument('--weights_path', type=str, default='./model/New_Tusimple_Lanenet_Model_Weights/tusimple_lanenet_vgg.ckpt',help='The model weights path')
    parser.add_argument('--weights_path', type=str, default="D:\\yinyuanqi\\lanenet-lane-detection-master\\model\\tusimple_lanenet_vgg\\tusimple_lanenet_vgg_line4.ckpt-10001", help='The model weights path')
    parser.add_argument('--save_dir', default='result/test_output', type=str, help='The test output save root dir')

    return parser.parse_args()


def lanenet_batch(src_dir, weights_path, save_dir):
    """
    ...
    with sess.as_default():
        ...
        for index, image_path in tqdm.tqdm(enumerate(image_list), total=len(image_list)):
            ...
            # print('1',binary_seg_image[0])
            # print('1',instance_seg_image[0])
            ...
            input_image_dir = ops.split(image_path.split('clips')[1])[0][1:]
            print(input_image_dir) #0313-1\10000
